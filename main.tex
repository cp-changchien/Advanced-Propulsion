...
\begin{gather*}
    \begin{split}
        &\text{From momentum conserv.:}\hspace*{0.4cm}U_A^2 = \frac{\rho_B}{\rho_A}U_B^2+\frac{P_B-P_A}{\rho_A}\hspace*{0.3cm}\Rightarrow\hspace*{0.3cm}U_A^2 = \frac{1}{\rho_A^2}\Bigg(\frac{P_B-P_A}{\rho_A^{-1}-\rho_B^{-1}}\Bigg)\\
        &\text{From mass conserv.:}\hspace*{1.3cm}U_B = \frac{\rho_A}{\rho_B}U_A\hspace*{0.3cm}\Rightarrow\hspace*{0.3cm}U_B^2 = \frac{1}{\rho_B^2}\Bigg(\frac{P_A-P_B}{\rho_B^{-1}-\rho_A^{-1}}\Bigg)\\
    \end{split} 
\end{gather*}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{Figure/cv.png}
\end{figure}
\vspace*{-0.4cm}
Assume stationary shock wave, change frame of reference moving with $U_x$
\begin{gather*}
    T_{max} = \rho_y(U_x-U_y)^2 + (P_y-P_x)A
\end{gather*}
...
\begin{gather*}
    ...
    \text{Similarly,}\hspace*{0.4cm}\gamma_f = \frac{f_{FA}R_f\gamma_f+R_{air}\gamma_{air}}{f_{FA}R_f+R_{air}}\\[0.2cm]
